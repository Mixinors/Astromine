...
public class AstromineDimensionType extends DimensionType {
	...
	protected AstromineDimensionType() {
		super(OptionalLong.of(15000L), false, false, false, false, false, false, false, false, true, false, 256, VoronoiBiomeAccessType.INSTANCE, BlockTags.INFINIBURN_END.getId(), 0.025f);
	}
}
