...
public class AstromineBlockEntityTypes {
	...
	public static final BlockEntityType<BlockBreakerBlockEntity> BLOCK_PLACER = register("block_placer", BlockBreakerBlockEntity::new, AstromineBlocks.BLOCK_PLACER);
