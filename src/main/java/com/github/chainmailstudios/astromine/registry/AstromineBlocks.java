...
public class AstromineBlocks {
	...
	public static final Block FUEL_MIXER = register("fuel_mixer", new FuelMixerBlock(FabricBlockSettings.of(Material.METAL).dropsNothing().strength(-1.0F, 3600000.8F).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
