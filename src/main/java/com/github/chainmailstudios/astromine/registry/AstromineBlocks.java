...
public class AstromineBlocks {
	...
	public static final Block DIRT_BUFFER = register("dirt_buffer", new BufferBlock(BufferType.DIRT, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
	public static final Block WOOD_BUFFER = register("wood_buffer", new BufferBlock(BufferType.WOOD, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
	public static final Block IRON_BUFFER = register("iron_buffer", new BufferBlock(BufferType.IRON, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
	public static final Block GOLD_BUFFER = register("gold_buffer", new BufferBlock(BufferType.GOLD, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
	public static final Block DIAMOND_BUFFER = register("diamond_buffer", new BufferBlock(BufferType.DIAMOND, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
	public static final Block EMERALD_BUFFER = register("emerald_buffer", new BufferBlock(BufferType.EMERALD, FabricBlockSettings.of(Material.METAL).dropsNothing().strength(1F, 4F).breakByTool(FabricToolTags.PICKAXES, 4).sounds(BlockSoundGroup.METAL)), AstromineItems.getBasicSettings());
