...
public class AstromineArmorMaterials {
	...
	public static final AstromineArmorMaterial ASTERITE = new AstromineArmorMaterial("asterite", 22, new int[]{4, 7, 8, 4}, 20, AstromineSounds.ASTERITE_ARMOR_EQUIPPED, 4.0f, 0.1f, () -> Ingredient.ofItems(AstromineItems.ASTERITE_FRAGMENT));
