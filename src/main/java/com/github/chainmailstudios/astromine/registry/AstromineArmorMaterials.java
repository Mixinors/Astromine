...
public class AstromineArmorMaterials {
	...
	public static final AstromineArmorMaterial ASTERITE = new AstromineArmorMaterial("asterite", 22, new int[]{4, 7, 8, 4}, 20, AstromineSounds.ASTERITE_ARMOR_EQUIPPED, 4.0f, 0.1f, () -> Ingredient.ofItems(AstromineItems.ASTERITE));
	...
	public static final AstromineArmorMaterial GALAXIUM = new AstromineArmorMaterial("galaxium", 44, new int[]{4, 8, 9, 4}, 18, AstromineSounds.GALAXIUM_ARMOR_EQUIPPED, 4.5f, 0.1f, () -> Ingredient.ofItems(AstromineItems.GALAXIUM));
