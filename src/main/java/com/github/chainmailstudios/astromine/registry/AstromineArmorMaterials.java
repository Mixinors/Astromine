...
public class AstromineArmorMaterials {
	...
	public static final AstromineArmorMaterial STELLUM = new AstromineArmorMaterial("stellum", 22, new int[] {2, 5, 6, 2}, 15, AstromineSounds.STELLUM_ARMOR_EQUIPPED, 6.0f, 0.2f, () -> Ingredient.ofItems(AstromineItems.STELLUM_INGOT));
