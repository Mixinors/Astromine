...
public class SpaceSkybox extends AbstractSkybox {
	...
	public void render(MatrixStack matrices, float tickDelta) {
		...
		buffer.vertex(matrices.peek().getModel(), -100.0F, (float) (-64.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), -100.0F).color(255, 255, 255, 255).texture(0.0F, 0.0F).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), -100.0F, (float) (-64.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), 100.0F).color(255, 255, 255, 255).texture(0.0F, 1.0F).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), 100.0F, (float) (-64.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), 100.0F).color(255, 255, 255, 255).texture(1.0F, 1.0F).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), 100.0F, (float) (-64.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), -100.0F).color(255, 255, 255, 255).texture(1.0F, 0.0F).light(vertexLight).next();
		...
		buffer.vertex(matrices.peek().getModel(), -100.0F, (float) (-60.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), -100.0F).color(255, 255, 255, 255).texture(u0, 0).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), -100.0F, (float) (-60.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), 100.0F).color(255, 255, 255, 255).texture(u0, 1).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), 100.0F, (float) (-60.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), 100.0F).color(255, 255, 255, 255).texture(u1, 1).light(vertexLight).next();
		buffer.vertex(matrices.peek().getModel(), 100.0F, (float) (-60.0F - (client.player.getY() < 0 ? client.player.getY() : client.player.getY())), -100.0F).color(255, 255, 255, 255).texture(u1, 0).light(vertexLight).next();
