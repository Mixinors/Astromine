...
public class TrituratorContainerScreen extends DefaultedEnergyItemContainerScreen<TrituratorContainer> {
	public TrituratorContainerScreen(Text name, DefaultedEnergyItemContainer linkedContainer, PlayerEntity player) {
		super(name, linkedContainer, player);

		TrituratorBlockEntity triturator = (TrituratorBlockEntity) linkedContainer.blockEntity;
