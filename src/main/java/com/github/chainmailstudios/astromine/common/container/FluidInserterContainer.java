...
public class FluidInserterContainer extends DefaultedEnergyFluidContainer {
	public FluidInserterContainer(int synchronizationID, PlayerInventory playerInventory, BlockPos blockPos) {
