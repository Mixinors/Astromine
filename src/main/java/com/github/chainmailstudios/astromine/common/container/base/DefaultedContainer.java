...
public class DefaultedContainer extends BaseContainer {
	public final Collection<WSlot> playerSlots;

	BlockState state;

	public DefaultedContainer(int synchronizationID, PlayerInventory playerInventory, BlockPos position) {
