...
public class FluidInserterScreenHandler extends DefaultedEnergyFluidScreenHandler {
	public FluidInserterScreenHandler(int synchronizationID, PlayerInventory playerInventory, BlockPos blockPos) {
