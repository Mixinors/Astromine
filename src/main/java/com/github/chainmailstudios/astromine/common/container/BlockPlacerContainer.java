...
public class BlockPlacerContainer extends DefaultedEnergyItemContainer {
	public BlockPlacerContainer(int synchronizationID, PlayerInventory playerInventory, BlockPos blockPos) {
	...
	public ScreenHandlerType<?> getType() {
		return AstromineContainers.BLOCK_PLACER;
	}
}
