...
public class SpaceEntityPlacer implements EntityPlacer {
    public static final SpaceEntityPlacer FALL_FROM_SPACE = new SpaceEntityPlacer(1024);
    public static final SpaceEntityPlacer ENTER_SPACE = new SpaceEntityPlacer(1);
