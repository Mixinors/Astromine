...
public class UseFireExtinguisherCriterion extends SimpleCriterionTrigger<UseFireExtinguisherCriterion.Conditions> implements IdentifiedCriterion {
	...
	public record Conditions(Optional<ContextAwarePredicate> player) implements SimpleInstance {
		...
		public static Criterion<Conditions> create() {
			return AMCriteria.USE_FIRE_EXTINGUISHER.createCriterion(new Conditions(Optional.empty()));
		}
	}
}
