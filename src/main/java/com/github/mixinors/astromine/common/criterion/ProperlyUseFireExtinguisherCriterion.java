...
public class ProperlyUseFireExtinguisherCriterion extends SimpleCriterionTrigger<ProperlyUseFireExtinguisherCriterion.Conditions> implements IdentifiedCriterion {
	...
	public record Conditions(Optional<ContextAwarePredicate> player) implements SimpleInstance {
		...
		public static Criterion<Conditions> create() {
			return AMCriteria.PROPERLY_USE_FIRE_EXTINGUISHER.createCriterion(new Conditions(Optional.empty()));
		}
	}
}
