...
public class AstromineFoundationsWorldGenGenerators extends AstromineWorldGenGenerators {
	public final WorldGenGenerator COPPER_ORE = register(new GenericOreFeatureWorldGenGenerator(AstromineFoundationsBlocks.COPPER_ORE, 0, 0, 64, 18, 11));
	...
	public final WorldGenGenerator TIN_ORE = register(new GenericOreFeatureWorldGenGenerator(AstromineFoundationsBlocks.TIN_ORE, 0, 0, 64, 16, 9));
}
