...
public class AstromineFoundationsRecipeGenerators extends AstromineRecipeGenerators {
	...
	public final RecipeGenerator PLATE_TO_WIRE_CRAFTING = register(new WireFromPlateRecipeGenerator(PLATE, Ingredient.of(FabricToolTags.SHEARS), WIRE, 1));
	...
	public final RecipeGenerator SMOOTH_METEOR_STONE = register(new SmeltingRecipeGenerator(Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE), AstromineFoundationsBlocks.SMOOTH_METEOR_STONE));

	public final RecipeGenerator POLISHED_METEOR_STONE = register(new Crafting2x2RecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), 4));
	public final RecipeGenerator METEOR_STONE_BRICKS = register(new Crafting2x2RecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICKS, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), 4));

	public final RecipeGenerator POLISHED_METEOR_STONE_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));
	public final RecipeGenerator METEOR_STONE_BRICKS_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICKS, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), "smooth"));
	public final RecipeGenerator METEOR_STONE_BRICKS_FROM_POLISHED_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICKS, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), "polished"));

	public final RecipeGenerator METEOR_STONE_SLAB = register(new SlabCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE)));
	public final RecipeGenerator METEOR_STONE_STAIRS = register(new StairsCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE)));
	public final RecipeGenerator METEOR_STONE_WALL = register(new WallCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_WALL, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE)));

	public final RecipeGenerator SMOOTH_METEOR_STONE_SLAB = register(new SlabCraftingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));
	public final RecipeGenerator SMOOTH_METEOR_STONE_STAIRS = register(new StairsCraftingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));
	public final RecipeGenerator SMOOTH_METEOR_STONE_WALL = register(new WallCraftingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_WALL, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));

	public final RecipeGenerator POLISHED_METEOR_STONE_SLAB = register(new SlabCraftingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE)));
	public final RecipeGenerator POLISHED_METEOR_STONE_STAIRS = register(new StairsCraftingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE)));

	public final RecipeGenerator METEOR_STONE_BRICK_SLAB = register(new SlabCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_SLAB, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS)));
	public final RecipeGenerator METEOR_STONE_BRICK_STAIRS = register(new StairsCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_STAIRS, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS)));
	public final RecipeGenerator METEOR_STONE_BRICK_WALL = register(new WallCraftingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_WALL, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS)));

	public final RecipeGenerator METEOR_STONE_SLAB_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE), 2));
	public final RecipeGenerator METEOR_STONE_STAIRS_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE)));
	public final RecipeGenerator METEOR_STONE_WALL_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_WALL, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE)));

	public final RecipeGenerator SMOOTH_METEOR_STONE_SLAB_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), 2));
	public final RecipeGenerator SMOOTH_METEOR_STONE_STAIRS_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));
	public final RecipeGenerator SMOOTH_METEOR_STONE_WALL_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE_WALL, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE)));

	public final RecipeGenerator POLISHED_METEOR_STONE_SLAB_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), 2));
	public final RecipeGenerator POLISHED_METEOR_STONE_STAIRS_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE)));

	public final RecipeGenerator POLISHED_METEOR_STONE_SLAB_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_SLAB, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), 2, "smooth"));
	public final RecipeGenerator POLISHED_METEOR_STONE_STAIRS_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.POLISHED_METEOR_STONE_STAIRS, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), "smooth"));

	public final RecipeGenerator METEOR_STONE_BRICK_SLAB_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_SLAB, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS), 2));
	public final RecipeGenerator METEOR_STONE_BRICK_STAIRS_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_STAIRS, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS)));
	public final RecipeGenerator METEOR_STONE_BRICK_WALL_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_WALL, Ingredient.of(AstromineFoundationsBlocks.METEOR_STONE_BRICKS)));

	public final RecipeGenerator METEOR_STONE_BRICK_SLAB_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_SLAB, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), 2, "smooth"));
	public final RecipeGenerator METEOR_STONE_BRICK_STAIRS_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_STAIRS, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), "smooth"));
	public final RecipeGenerator METEOR_STONE_BRICK_WALL_FROM_SMOOTH_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_WALL, Ingredient.of(AstromineFoundationsBlocks.SMOOTH_METEOR_STONE), "smooth"));

	public final RecipeGenerator METEOR_STONE_BRICK_SLAB_FROM_POLISHED_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_SLAB, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), 2, "polished"));
	public final RecipeGenerator METEOR_STONE_BRICK_STAIRS_FROM_POLISHED_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_STAIRS, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), "polished"));
	public final RecipeGenerator METEOR_STONE_BRICK_WALL_FROM_POLISHED_STONECUTTING = register(new StonecuttingRecipeGenerator(AstromineFoundationsBlocks.METEOR_STONE_BRICK_WALL, Ingredient.of(AstromineFoundationsBlocks.POLISHED_METEOR_STONE), "polished"));
}
