...
public class AstromineTechnologiesRecipeGenerators extends AstromineRecipeGenerators {
	public final RecipeGenerator BLOCK_TO_DUSTS = register(new TrituratingSetRecipeGenerator(BLOCK, DUST, 9, 120, 540));
	public final RecipeGenerator BLOCK_2x2_TO_DUSTS = register(new TrituratingSetRecipeGenerator(BLOCK_2x2, DUST, 4, 80, 480));
	public final RecipeGenerator BLOCK_2x2_TO_MISC = register(new TrituratingSetRecipeGenerator(BLOCK_2x2, MISC_RESOURCE, 4, 60, 340));
	public final RecipeGenerator ORE_TO_DUSTS = register(new TrituratingSetRecipeGenerator(ORE, DUST, 2, 90, 340));
	public final RecipeGenerator METEOR_ORE_TO_TINY_DUSTS = register(new TrituratingSetRecipeGenerator(METEOR_ORE, TINY_DUST, 6, 90, 340));
	public final RecipeGenerator METEOR_CLUSTER_TO_TINY_DUSTS = register(new TrituratingSetRecipeGenerator(METEOR_CLUSTER, TINY_DUST, 3, 90, 340));
	public final RecipeGenerator INGOT_TO_DUST = register(new TrituratingSetRecipeGenerator(INGOT, DUST, 30, 270));
	public final RecipeGenerator GEM_TO_DUST = register(new TrituratingSetRecipeGenerator(GEM, DUST, 30, 270));
	...
	public final RecipeGenerator SOUL_SAND_FROM_SOIL = register(new TrituratingRecipeGenerator("soul_sand_from_soil", Ingredient.ofItems(Blocks.SOUL_SOIL), Blocks.SOUL_SAND, 20, 120));

	public final RecipeGenerator WHITE_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("white_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.WHITE_CONCRETE), Blocks.WHITE_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator ORANGE_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("orange_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.ORANGE_CONCRETE), Blocks.ORANGE_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator MAGENTA_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("magenta_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.MAGENTA_CONCRETE), Blocks.MAGENTA_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator LIGHT_BLUE_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("light_blue_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.LIGHT_BLUE_CONCRETE), Blocks.LIGHT_BLUE_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator YELLOW_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("yellow_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.YELLOW_CONCRETE), Blocks.YELLOW_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator LIME_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("lime_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.LIME_CONCRETE), Blocks.LIME_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator PINK_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("pink_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.PINK_CONCRETE), Blocks.PINK_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator GRAY_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("gray_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.GRAY_CONCRETE), Blocks.GRAY_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator LIGHT_GRAY_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("light_gray_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.LIGHT_GRAY_CONCRETE), Blocks.LIGHT_GRAY_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator CYAN_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("cyan_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.CYAN_CONCRETE), Blocks.CYAN_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator PURPLE_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("purple_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.PURPLE_CONCRETE), Blocks.PURPLE_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator BLUE_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("blue_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.BLUE_CONCRETE), Blocks.BLUE_CONCRETE_POWDER, 10, 50));
	public final RecipeGenerator BROWN_CONCRETE_POWDER_FROM_CONCRETE = register(new TrituratingRecipeGenerator("brown_concrete_powder_from_triturating_concrete", Ingredient.ofItems(Blocks.BROWN_CONCRETE), Blocks.BROWN_CONCRETE_POWDER, 10, 50));
